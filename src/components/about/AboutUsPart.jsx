          ...
          <Grid className={styles.whoContainer}>
            <Grid className={styles.whoweLeft}>
              ...
              >
                ...
                services in Software development (Ruby on Rails, ReactJS, NextJs
        ...
        <Grid>
          <Grid className={styles.uspContainer}>
            <Grid className={styles.coreQuote}>
              ...
              >
                ‘Our passion for every project that comes our way' is how the
                USP can be defined in a single phrase. But we believe in
