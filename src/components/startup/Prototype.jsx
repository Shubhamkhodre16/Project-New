   ...
   return (
    <Box>
      ...
      <Grid container spacing={2} className={styles.imageSLider}> 
        <Grid size={{xs:12,sm:12,md:12,lg:12}} className={styles.imageGrid} style={{ transform: `translateX(-${currentSlide * 100}%)`, width: '100%',     }} >
      ...
      {/* {/ Prototype Section /} */}
       <Grid container  className={styles.PrototypeContainer}>
        <Grid size={{xs:12,sm:12,md:6,lg:6}} className={styles.PrototypeImage} >
         <Image src={revolutionary} alt="revolutionary" width={400} height={100}/>
         </Grid>
       ...
       <Grid container className={styles.techPartnerContainer}>
        <Grid size={{xs:12,sm:12,lg:12,md:12}} className={styles.techPartner} >
          <Image src={trustedPartner} alt='techPartner' width={80} height={80}/>
          <Typography className={styles.techPartnerTitle} sx={{fontSize:{lg:"25px",md:"22px",sm:"25px",xs:"22px"}, fontFamily: "NovemberPro"}} > A Trusted tech partner for start-ups
          and start-up accelerators</Typography>
        </Grid>
        <Grid  className={styles.techPartnerStartup}>
          <Grid size={{xs:12,sm:12,md:6,lg:6}} className={styles.techPartnerLeft}>
       ...
       <Grid container className={styles.weServer}>
        <Grid size={{xs:12,sm:12,md:12,lg:12}} className={styles.youWish} >
          <Typography className={styles.youWishTitle} sx={{fontSize:{lg:"25px",md:"22px",sm:"25px",xs:"22px"},fontFamily:"NovemberPro"}} > You wish we serve</Typography>
          <Typography className={styles.youWishDesc}  sx={{fontSize:{lg:"18px",md:"16px ",sm:"18px",xs:"16px"},fontFamily:"NovemberPro-Reg"}}>Whether you’re intending to build an impressive prototype for getting funding, an MVP to
        ...
        <Grid container spacing={6} className={styles.infoContainer} >
          <Grid size={{xs:12,sm:12,md:6,lg:6}} className={styles.infocontent}>
            <Typography className={styles.infoTitle} sx={{fontSize:{lg:"25px",md:"22px",sm:"25px",xs:"22px"},fontFamily:"NovemberPro"}} >Advantageous Info of InfoKoders Technologies Software Development Teams for Start-ups</Typography>
            <Typography className={styles.infoSubTitle} sx={{fontSize:{lg:"18px",md:"16px ",sm:"18px",xs:"16px"},fontFamily:"NovemberPro-Reg"}}>We understand the complication of getting the right people who can smoothly manage the whole product development process, but not with InfoKoders Technologies. Our unique methodology, systematic product development process, and skillful resources have been praised by our beloved clients</Typography> 
          </Grid>
          <Grid size={{xs:12,sm:12,md:6,lg:6}} className={styles.boxGrid} >
              <Grid  className={styles.whiteBox}>
                <Typography className={styles.whiteBoxTitle} sx={{fontSize:{lg:"20px",md:"20px",sm:"20px",xs:"20px"},fontFamily:"NovemberPro"}}>100+</Typography>
                <Typography className={styles.whiteBoxDesc} sx={{fontSize:{lg:"16px",md:"16px",sm:"16px",xs:"16px"},fontFamily:"NovemberPro-Reg"}} >Engineers across USA and UAE</Typography>
              </Grid>
              <Grid  className={styles.whiteBox}>
                <Typography className={styles.whiteBoxTitle} sx={{fontSize:{lg:"20px",md:"20px",sm:"20px",xs:"20px"},fontFamily:"NovemberPro"}} >20+</Typography>
                 <Typography className={styles.whiteBoxDesc} sx={{fontSize:{lg:"16px",md:"16px",sm:"16px",xs:"16px"},fontFamily:"NovemberPro-Reg"}}>Successfully launched tech products</Typography>
              </Grid>
              <Grid  className={styles.whiteBox}>
                <Typography className={styles.whiteBoxTitle} sx={{fontSize:{lg:"20px",md:"20px",sm:"20px",xs:"20px"},fontFamily:"NovemberPro"}} >5</Typography>
                <Typography className={styles.whiteBoxDesc} sx={{fontSize:{lg:"16px",md:"16px",sm:"16px",xs:"16px"},fontFamily:"NovemberPro-Reg"}}>Years of experience</Typography>
              </Grid>
          </Grid>
        </Grid>
        ...
        <Grid container spacing={3} className={styles.obstaclesContainer}>
          <Grid size={{xs:12,sm:12,md:6,lg:6}} className={styles.obstaclesLeft}>
            <Typography className={styles.obstaclesLeftTitle}sx={{fontSize:{lg:"25px",md:"22px",sm:"25px",xs:"22px"},fontFamily:"NovemberPro"}}>What obstacles InfoKoders Technologies can tackle for startups?</Typography>
            <Typography className={styles.obstaclesLeftDesc} sx={{fontSize:{lg:"18px",md:"16px",sm:"18px",xs:"16px"},fontFamily:"NovemberPro-Reg"}} >In a start-up journey, you probably have come through a lot of rough paths, however, we are going turn out to be your supportive software development team that going to rescue your startup from all struggles like:</Typography>
          </Grid>
          <Grid size={{xs:12,sm:12,md:6,lg:6}} className={styles.obstaclesRight}>
            ...
            <Typography className={styles.obstaclesRightTitle} sx={{fontSize:{lg:"18px",md:"16px",sm:"18px",xs:"16px"},fontFamily:"NovemberPro-Reg"}}>
            <TripOriginIcon className={styles.obstaclesRightIcon} />Complications in scaling product development
            </Typography>
          </Grid>
        </Grid>
         {/* Uplift your startup? */}
        <Grid container spacing={3} className={styles.upliftStartup}>
          ...
          <Grid size={{xs:12,sm:12,md:6,lg:6}}  >
              {upliftData.map((item,index)=>(
                ...
                <Typography className={styles.upliftData} sx={{fontSize:{lg:"20px",md:"18px",sm:"20px",xs:"20px"},fontFamily:"NovemberPro"}} >{item.title}</Typography>
                <Typography className={styles.upliftDataDesc} sx={{fontSize:{lg:"16px",md:"14px",sm:"16px",xs:"16px"},fontFamily:"NovemberPro-Reg"}}>{item.desc}</Typography>
                </Grid>
            )  ))}
          </Grid>
          <Grid size={{xs:12,sm:12,md:6,lg:6}}  >
