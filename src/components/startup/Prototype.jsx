      ...
      {/* {/ Prototype Section /} */}
       <Grid container  className={styles.PrototypeContainer}>
        <Grid size={{xs:12,sm:12,md:6,lg:6}} className={styles.PrototypeImage} >
         <Image src={revolutionary} alt="revolutionary" width={450} height={100}/>
         </Grid>
       ...
       <Grid container className={styles.techPartnerContainer}>
        <Grid size={{xs:12,sm:12,lg:12,md:12}} className={styles.techPartner} >
          ...
          <Typography className={styles.techPartnerTitle} sx={{fontSize:{lg:"24px",md:"22px",sm:"24px",xs:"20px"}, fontFamily: "NovemberPro"}} > A Trusted tech partner for start-ups
        ...
        <Grid  className={styles.techPartnerStartup}>
          <Grid size={{xs:12,sm:12,md:6,lg:6}} className={styles.techPartnerLeft}>
           ...
           <Typography className={styles.techPartnersSubTitle} sx={{fontSize:{lg:"20px",md:"18px ",sm:"18px",xs:"16px"},fontFamily:"NovemberPro-Reg"}}>We collaborate with start-up founders, deeply understand the project concept, and brainstorm to generate unique ideas. Followed by crafting a detailed roadmap of the next steps, then getting into the product design stage. Under this stage, we attractively design the product user experience and user interface that depict your business goals and raise your end-users expectations. Lastly, we develop a quality rich and bug-free product and smoothly launch it on the market.</Typography>
            <Button className={styles.PrototypeButton} sx={{fontSize:{lg:"16px",md:"16px",sm:"16px",xs:"14px"},fontFamily:"NovemberPro-Reg"}}>Let your product rock with us</Button>
          </Grid>
          <Grid size={{xs:12,sm:12,md:6,lg:6}} className={styles.techPartnerRight}>
            ...
            <Button className={styles.PrototypeButton} sx={{fontSize:{lg:"16px",md:"16px",sm:"16px",xs:"14px",marginTop:"30px"},fontFamily:"NovemberPro-Reg"}}>Join hands as a tech partner</Button>
          </Grid>
        </Grid>
       </Grid>
       {/* {/ You wish we serve /} */}
       <Grid container className={styles.weServer}>
        <Grid size={{xs:12,sm:12,md:12,lg:12}} className={styles.youWish} >
          <Typography className={styles.youWishTitle} sx={{fontSize:{lg:"24px",md:"22px",sm:"24px",xs:"22px"},fontFamily:"NovemberPro"}} > You wish we serve</Typography>
          <Typography className={styles.youWishDesc}  sx={{fontSize:{lg:"20px",md:"18px ",sm:"18px",xs:"16px"},fontFamily:"NovemberPro-Reg"}}>Whether you’re intending to build an impressive prototype for getting funding, an MVP to
        ...
        <Grid container spacing={6} className={styles.infoContainer} >
          <Grid size={{xs:12,sm:12,md:6,lg:6}} className={styles.infocontent}>
            <Typography className={styles.infoTitle} sx={{fontSize:{lg:"24px",md:"22px",sm:"24px",xs:"22px"},fontFamily:"NovemberPro"}} >Advantageous Info of InfoKoders Technologies Software Development Teams for Start-ups</Typography>
            <Typography className={styles.infoSubTitle} sx={{fontSize:{lg:"20px",md:"18px ",sm:"18px",xs:"16px"},fontFamily:"NovemberPro-Reg"}}>We understand the complication of getting the right people who can smoothly manage the whole product development process, but not with InfoKoders Technologies. Our unique methodology, systematic product development process, and skillful resources have been praised by our beloved clients</Typography> 
          </Grid>
          <Grid size={{xs:12,sm:12,md:6,lg:6}} className={styles.boxGrid} >
              <Grid  className={styles.whiteBox}>
                <Typography className={styles.whiteBoxTitle} sx={{fontSize:{lg:"24px",md:"22px",sm:"24px",xs:"22px"},fontFamily:"NovemberPro"}}>100+</Typography>
                <Typography className={styles.whiteBoxDesc} sx={{fontSize:{lg:"18px",md:"14px",sm:"18px",xs:"16px"},fontFamily:"NovemberPro-Reg"}} >Engineers across USA and UAE</Typography>
              </Grid>
              <Grid  className={styles.whiteBox}>
                <Typography className={styles.whiteBoxTitle} sx={{fontSize:{lg:"24px",md:"22px",sm:"24px",xs:"22px"},fontFamily:"NovemberPro"}} >20+</Typography>
