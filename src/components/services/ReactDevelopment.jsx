...
const ReactDevelopment = () => {
  ...
  const contactSubtitle="Looking for top-notch ReactJS development services? Partner with InfoKoders Technologies and get a scalable, secure, and high-performing web application tailored to your business needs."
  return (
    <Box>
      ...
      <Grid container spacing={3} className={styles.angularContainer}>
        <Grid size={{xs:12,sm:12,md:6,lg:6}}>
          <Typography className={styles.angularintro} sx={{fontSize:{lg:"25px",md:"22px",sm:"25px",xs:"22px"},fontFamily:"NovemberPro"}} ><span className={styles.OurUsp}>ReactJS Development</span> Company</Typography>
          <Typography className={styles.angularContent} sx={{fontSize:{lg:"18px",md:"16px",sm:"18px",xs:"16px"},fontFamily:"NovemberPro-Reg",fontWeight:"bold"}}  >Empower Your Web Applications with ReactJS</Typography>
          <Typography className={styles.angularContent} sx={{fontSize:{lg:"18px",md:"16px",sm:"18px",xs:"16px"},fontFamily:"NovemberPro-Reg"}}>At <b>InfoKoders</b>, we offer expert <b>ReactJS development services</b> to build highly dynamic, fast, and scalable web applications. ReactJS, maintained by Facebook, is a powerful JavaScript library that enables the development of interactive UIs and high-performance applications.</Typography>
          <Typography className={styles.angularContent} sx={{fontSize:{lg:"18px",md:"16px",sm:"18px",xs:"16px"},fontFamily:"NovemberPro-Reg"}}>Whether you need a custom web application, <b>single-page application (SPA)</b>, enterprise-grade solution, or API-driven development, our experienced <b>ReactJS developers</b> deliver robust, secure, and feature-rich applications tailored to your business needs.</Typography>
          <Button sx={{fontSize:{lg:"16px",md:"14px",sm:"16px",xs:"14px"},fontFamily:"NovemberPro-Reg",cursor:"pointer",padding:"8px 18px",border:"1px solid transparent",color:"#ffffff",backgroundColor:"#333",marginTop:"1rem",marginBottom:"1rem",textTransform:"none"}} onClick={()=>setOpen(true)}>Let's connect</Button>
        {open && <ContactUsModal open={open} setOpen={setOpen}/>}
        </Grid>
        <Grid size={{xs:12,sm:12,md:6,lg:6}} sx={{alignItems:"center",display:"flex",justifyContent:"center"}}>
          <Image src={reactDevelop} alt="image of the react development company" width={600} height={300}/>
        </Grid>
          </Grid> 
          ...
          <Grid container className={styles.ProcessContainer}>
                      <Grid size={{xs:12,sm:12,md:12,lg:12}} className={styles.ProcessGrid}>
                        <Typography className={styles.obstaclesLeftTitle}  sx={{
                          ...
                          }}>Our <span className={styles.OurUsp}> ReactJS </span>Development Services</Typography>
                      </Grid>
                      ...
                      <Grid size={{xs:12,sm:12,md:6,lg:4}} className={styles.cardsProcessangular} key={index}>
                        ...
                        <Typography className={styles.obstaclesLeftDesc} sx={{
                            fontSize: {
                              ...
                              sm: "16px ",
                              xs: "16px",
                            },fontFamily: "NovemberPro-Reg"}}>{item?.desc}</Typography>
                        </Grid>
                      ))}
                      </Grid>
                    </Grid>
          ...
          <Grid container className={styles.servicesContainer}>
             <Grid>
              <Typography className={styles.coreTitleUsp} sx={{fontSize:{lg:"25px",md:"22px",sm:"25px",xs:"22px"},fontFamily:"NovemberPro",paddingBottom:"20px"}}>Why Partner with InfoKoders Technologies?</Typography>
             </Grid>
             <Grid container spacing={3}>
             {partner?.map((item,index)=>(
             <Grid size={{xs:12,sm:12,md:6,lg:4}} key={index} className={styles.uspBox}>
              <Image src={item?.image} alt="images not found of the why partner with infokoders technologies cards" width={90} height={90}/>
              <Typography className={styles.uspBoxTitle} sx={{fontSize:{lg:"20px",md:"20px",sm:"20px",xs:"20px"},fontFamily:"NovemberPro",marginTop:"10px"}}>{item?.title}</Typography>
              <Typography className={styles.uspBoxDesc} sx={{fontSize:{lg:"16px",md:"16px",sm:"16px",xs:"16",marginTop:"10px",fontFamily:"NovemberPro-Reg"}}}>{item?.desc}</Typography>
             </Grid>
             ))}
            </Grid>  
            </Grid>
            ...
            <Grid container className={styles.reactProcessContainer}>
              <Grid>
                <Typography className={styles.reactProcessTitle} sx={{fontSize:{lg:"25px",md:"22px",sm:"25px",xs:"22px"},fontFamily:"NovemberPro",paddingBottom:"20px"}}>Our<span className={styles.OurUsp}> ReactJS</span> Development Process</Typography>
              </Grid>
              <Grid container spacing={3} >
                {development?.map((item,index)=>(
                <Grid size={{xs:12,sm:12,md:6,lg:4}} key={index} className={styles.reactdevelopment}>
                          <Image src={item?.image} alt="images not found of the our reactjs development process" width={90} height={90}/>
                          <Typography className={styles.uspBoxTitle} sx={{fontSize:{lg:"20px",md:"20px",sm:"20px",xs:"20px"},fontFamily:"NovemberPro",marginTop:"10px"}}>{item?.title}</Typography>
                           <Typography className={styles.uspBoxDesc} sx={{fontSize:{lg:"16px",md:"16px",sm:"16px",xs:"16px"},fontFamily:"NovemberPro-Reg",marginTop:"10px"}} >{item?.desc}</Typography>
                </Grid>
                ))}
              </Grid>
            </Grid>
