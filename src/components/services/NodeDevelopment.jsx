...
const NodeDevelopment = () => {
  ...
  const contactTitle="Seeking for Right Nodejs development team to hand over a project?"
  const contactSubtitle="Zealous Nodejs developers, agile development process, or quality rich Nodejs development. Whatever you are looking for, InfoKoders technologies can help you with any kind of requirements."
  return (
    <Box>
      ...
      <Grid container spacing={3} className={styles.obstaclesContainer}>
          ...
          <Grid size={{xs:12,sm:12,md:6,lg:6}} className={styles.obstaclesRightNode}>
            <Typography className={styles.obstaclesRightTitle} sx={{fontSize:{lg:"18px",md:"16px",sm:"18px",xs:"16px"},fontFamily:"NovemberPro-Reg"}}>
              <TripOriginIcon className={styles.obstaclesRightIcon} />Creation of a stable underlying structure for mobile application
            </Typography >
            <Typography className={styles.obstaclesRightTitle} sx={{fontSize:{lg:"18px",md:"16px",sm:"18px",xs:"16px"},fontFamily:"NovemberPro-Reg"}}>
              <TripOriginIcon className={styles.obstaclesRightIcon} /> High-performance enterprise app development
            </Typography>
            <Typography className={styles.obstaclesRightTitle} sx={{fontSize:{lg:"18px",md:"16px",sm:"18px",xs:"16px"},fontFamily:"NovemberPro-Reg"}}>
              <TripOriginIcon className={styles.obstaclesRightIcon} />Faster SDLC app development cycles for complex and large-scale SDLC apps
            </Typography>
            <Typography className={styles.obstaclesRightTitle} sx={{fontSize:{lg:"18px",md:"16px",sm:"18px",xs:"16px"},fontFamily:"NovemberPro-Reg"}}>
              <TripOriginIcon className={styles.obstaclesRightIcon}/>Client requested customization with 30% less code
            </Typography>
          </Grid>
        </Grid>
        ...
        <Grid container className={styles.uspContainer}>
            <Grid className={styles.coreQuote}>
              ...
              >
                Are you looking for a business-changing Node.js Development Company to take up your project? Then confidently count on us for cutting-edge solutions in a shorter turnaround time. We are highly acclaimed among global clients for providing world-class Nodejs development services
              </Typography>
            </Grid>
          ...
          <Grid container className={styles.ProcessContainer}>
            <Grid size={{xs:12,sm:12,md:12,lg:12}} className={styles.ProcessGrid}>
              <Typography className={styles.obstaclesLeftTitle}  sx={{
                  fontSize:{lg:"25px",md:"22px",sm:"25px",xs:"22px"},fontFamily:"NovemberPro"
                }}>Our <span className={styles.OurUsp}>Nodejs website </span>and <span className={styles.OurUsp}>Mobile app development </span>Process Enterprises?</Typography>
              <Typography className={styles.obstaclesLeftDesc}  sx={{
                ...
                }}>We gained prominence in the website and mobile app development realm because of our systematic and well-selected development process. We follow the agile software development process, an international standard process for software development.</Typography>
            </Grid>
            <Grid container spacing={3} className={styles.cardsContainer} >
            {Process?.map((item,index)=>(
            <Grid size={{xs:12,sm:12,md:6,lg:4}} className={styles.cardsProcess} key={index}>
              <Typography  className={styles.obstaclesLeftTitle}  sx={{
                  fontSize: {
                    lg: "20px ",
                    md: "20px ",
          ...
          <Grid size={{xs:12,sm:12,md:12,lg:12}} className={styles.gridExpert} >
            <Typography className={styles.coreTitleUsp}
                sx={{
                  fontSize:{lg:"25px",md:"22px",sm:"25px",xs:"22px"},fontFamily:"NovemberPro"
                }}>  Hire Project-Based Nodejs developers under our Flexible Engagements Models</Typography>
            <Typography className={styles.coreDescriptionUsp}
                ...
                }}>We have a client satisfying onshore/offshore project execution model in place, with centers in the United States, the UK, and India. Being a top Node.JS Development Company InfoKoders technologies presents you the flexible engagement plans for software development projects that are tailored to the needs of the client.
                </Typography>
          </Grid>
        {/* node card */}
        <Grid
            ...
            <Typography sx={{
                  fontSize: {
                    ...
                    sm: "18px ",
                    xs: "16px",
                  },fontFamily: "NovemberPro-Reg"}} className={styles.belowCardTitle}>If you require Node.JS programmers for a longer period or SMEs, we have the right people to serve your requirements</Typography>
        </Grid>
        ...
        <Grid>
          <Grid className={styles.rubypartnerContainer}>
            <Grid className={styles.coreQuote}>
              ...
              >
                We have successfully developed and launched big projects in a variety of industries and business sizes. With an unbelievable track record of client retention, InfoKoders technologies has proven to be a leading Nodejs mobile and website development company.
              </Typography>
            </Grid>
            <Grid container spacing={4} className={styles.coresubcont}>
