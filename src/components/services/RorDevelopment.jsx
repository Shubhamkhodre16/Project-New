...
const RorDevelopment = () => {
  ...
  const contactSubtitle="Share your requirements with us, and we'll analyze them for you."
  return (
    <Box>
        ...
        <Grid>
          <Grid className={styles.rubypartnerContainer}>
            <Grid className={styles.coreQuote}>
              ...
              >
                As a client-oriented <b>Ruby on Rails Development Company,</b> we hold highly skilled and expert Ruby on Rails developers who use the best gems and Rails modules to help you scale your business. We can assist you in maximizing all of the benefits of Ruby on Rails and assuring you to get advanced quality apps for better and smoother operation.
              </Typography>
            </Grid>
            <Grid container spacing={4} className={styles.coresubcont}>
