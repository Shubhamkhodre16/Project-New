...
const HerokuDevelopment = () => {
  ...
  contactSubtitle="Access top-of-the-line and specialized Heroku development service from the InfoKoders technologies team and enjoy your business transformation in different ways."
  return (
    <Box>
      ...
      <Grid container className={styles.uspContainer}>
            <Grid className={styles.coreQuote}>
             ...
             Our Heroku Development Services
              ...
              >
              Being a reliable and trusted Heroku service partner, we emphasize to develop the out of box applications without getting distracted on maintaining servers, hardware, or infrastructure
              </Typography>
            </Grid>
          ...
          <Grid container className={styles.ProcessContainer}>
            <Grid size={{xs:12,sm:12,md:12,lg:12}} className={styles.ProcessGrid}>
              <Typography className={styles.obstaclesLeftTitle}  sx={{
                  fontSize:{lg:"25px",md:"22px",sm:"25px",xs:"22px"},fontFamily:"NovemberPro"
                }}>One Ultimate platform for all your secure app <span className={styles.OurUsp}> development needs </span></Typography>
              <Typography className={styles.obstaclesLeftDesc}  sx={{
                ...
                }}>Whether you are a start-up, enterprise, or large tech organization we provide a Heroku-based solution, a potential cloud platform as a Service(PaaS) enabling us to precisely build, deploy and manage your dream apps. Being one of the leading <b>Heroku service partners ,</b> our developers focus on creating great user experiences without worrying about managing servers (virtual or otherwise), hardware, or infrastructure, thus, resulting in the biggest hit solutions.</Typography>
            </Grid>
          ...
          <Grid className={styles.rubypartnerContainer}>
            <Grid className={styles.coreQuote}>
              ...
              > Why count on InfoKoders technologies as your right
                <span className={styles.OurUsp}> Heroku development </span> partner?
              </Typography>
              <Typography
              ...
              >
                There are quite a great many facts that reflect how InfoKoders technologies deserves to be your best Heroku development company.
              </Typography>
              <Typography
                className={styles.coreDescriptionUsppartner}
                sx={{
                  fontSize: {
                    ...
                    sm: "18px ",
                    xs: "16px",
                  },fontFamily: "NovemberPro-Reg",marginTop:"1rem"
                }}
              >
                <b>Certified and experienced Heroku developers</b> without owing a vibrant and high spirited Heroku development team it’s unimaginable to embrace high tech web or app development solutions. That’s the main reason we are known for. We are guarded with a vision-oriented Heroku developers that commit to offer satisfied solutions
              </Typography>
            </Grid>
            <Grid container spacing={4} className={styles.coresubcont}>
        ...
        {/* How Heroku is different from other cloud platforms? */}
           <Grid container className={styles.ProcessContainerHeroku}>
            <Grid size={{xs:12,sm:12,md:12,lg:12}} className={styles.ProcessGrid}>
              <Typography className={styles.ProcessHerokuTitle}  sx={{
                  fontSize:{lg:"25px",md:"22px",sm:"25px",xs:"22px"},fontFamily:"NovemberPro"
                }}>How Heroku is different from other cloud platforms?</Typography>
              <Typography className={styles.ProcessHerokuDesc}  sx={{
                  fontSize: {
                    lg: "18px ",
                    md: "16px ",
                    sm: "18px ",
                ...
                }}>No matter if you are looking to develop a simple prototype or a mission-critical product. Whatever the size and scope of your projects can be, Heroku proves to be the best, directing our developers the quickest path to deliver engaging apps with the use of diverse tools and technologies The platform’s flexibility and designed experience support encourage our team to adopt development style suitable for your project needs.</Typography>
            </Grid>
            <Grid container spacing={3} className={styles.cardsContainer} >
