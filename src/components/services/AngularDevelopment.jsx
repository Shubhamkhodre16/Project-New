...
const AngularDevelopment = () => {
  ...
  const contactSubtitle="Looking for reliable AngularJS development services? Partner with InfoKoders technologies and get a high-performing, scalable, and secure web application tailored to your business needs."
  return (
    <Box>
      ...
      {/* AngularJS Development Company */}
       <Grid container spacing={3} className={styles.angularContainer}>
        <Grid size={{xs:12,sm:12,md:6,lg:6}}>
          <Typography className={styles.angularintro} sx={{fontSize:{lg:"25px",md:"22px",sm:"25px",xs:"22px"},fontFamily:"NovemberPro"}}><span className={styles.OurUsp}>AngularJS Development</span> Company</Typography>
          <Typography className={styles.angularContent}sx={{fontSize:{lg:"18px",md:"16px",sm:"18px",xs:"16px"},fontFamily:"NovemberPro-Reg",fontWeight:"bold"}}>Empower Your Web Applications with AngularJS</Typography>
          <Typography className={styles.angularContent} sx={{fontSize:{lg:"18px",md:"16px",sm:"18px",xs:"16px"},fontFamily:"NovemberPro-Reg"}}>At <b>InfoKoders</b>, we offer top-notch <b>AngularJS development services</b> to build highly interactive, scalable, and feature-rich web applications. As a powerful JavaScript framework maintained by Google,<b> AngularJS</b> provides a robust foundation for dynamic web applications with seamless user experiences.</Typography>
           <Typography className={styles.angularContent} sx={{fontSize:{lg:"18px",md:"16px",sm:"18px",xs:"16px"},fontFamily:"NovemberPro-Reg"}}>Whether you need a custom web application, single-page application (SPA), enterprise-grade solution, or API-driven development, our skilled <b>AngularJS developers</b> have the expertise to turn your vision into reality.</Typography>
        ...
        <Grid size={{xs:12,sm:12,md:6,lg:6}} sx={{alignItems:"center",display:"flex",justifyContent:"center"}}>
          <Image src={angularcontent} alt="angular development company" width={600} height={300}/>
        </Grid>
       </Grid>
       ...
       {/* Our AngularJS Development Services */}
          <Grid container className={styles.ProcessContainer}>
            <Grid size={{xs:12,sm:12,md:12,lg:12}} className={styles.ProcessGrid}>
              <Typography className={styles.obstaclesLeftTitle}  sx={{
                ...
                }}>Our <span className={styles.OurUsp}> AngularJS </span>Development Services</Typography>
            </Grid>
            ...
            >
              {solution?.map((item, index) => (
                ...
                >
                  ...
                  />
                  <Typography
                    sx={{ marginBottom: "10px", fontFamily: "NovemberPro",fontSize:{lg:"20px",md:"20px",sm:"20px",xs:"20px"},color:"#333333",marginTop:"10px" }}
                  >
                    {item?.title}
                  </Typography>
                  <Typography
        ...
        <Grid container className={styles.development}>
          ...
          {development?.map((item,index)=>(
            <Grid size={{xs:12,sm:12,md:6,lg:4}} key={index} className={styles.developmentCard} >
                     <Image src={item?.image} alt="images not found of development process" width={80} height={80}/>
                     <Typography sx={{fontSize:{lg:"20px",md:"20px",sm:"20px",xs:"20px"},fontFamily:"NovemberPro",marginTop:"10px"}} className={styles.Industriestitle}>{item?.title}</Typography>
                     <Typography sx={{fontSize:{lg:"16px",md:"16px",sm:"16px",xs:"16px"},fontFamily:"NovemberPro-Reg"}} className={styles.developmentdesc}>{item?.desc}</Typography>
                     </Grid>
              ))}
          </Grid>
        </Grid>
