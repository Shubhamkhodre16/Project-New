  ...
  const[open,setOpen]=useState(false);
    ...
    const Process=[
      ...
      },
      {
        ...
        desc1:"Designing low-fidelity wireframes to structure the interface layout.",
      ...
      },
      {
        ...
        desc1:"Creating visually stunning, brand-aligned UI elements for consistency.",
        desc2:"Applying color schemes, typography, and design components that enhance user engagement.",
        desc3:"Ensuring accessibility and responsiveness across all devices."
      },
      {
        title:"Usability Testing & Feedback",
        desc1:"Conducting A/B testing, heatmaps, and user testing sessions to gather insights.",
        desc2:"Identifying usability issues and refining designs for better engagement.",
        desc3:"Optimizing performance for speed, accessibility, and responsiveness.",
      },
      {
        title:"Development & Implementation",
        desc1:"Collaborating with developers to bring the designs to life.",
        desc2:"Ensuring seamless integration with frontend and backend technologies.",
      ...
      },
      {
        ...
        desc3:"Making iterative improvements based on user behavior and analytics."
      }
    ]
    const Design=[
      { 
    ...
    const contactSubtitle="Your users deserve a seamless and engaging experience. Let's create a UI/UX design that enhances your digital product and sets you apart from the competition."
  return (
    <Box>
        ...
        <Grid container spacing={3} className={styles.angularContainer}>
          <Grid size={{xs:12,sm:12,md:6,lg:6}}>
            <Typography className={styles.angularintro} sx={{fontSize:{lg:"25px",md:"22px",sm:"25px",xs:"22px"},fontFamily:"NovemberPro"}}><span className={styles.OurUsp}>UI/UX Development</span> Company</Typography>
            <Typography className={styles.angularContent} sx={{fontSize:{lg:"18px",md:"16px",sm:"18px",xs:"16px",fontWeight:"bold",fontFamily:"NovemberPro-Reg"}}}>Delivering Seamless and Engaging User Experiences</Typography>
            <Typography className={styles.angularContent} sx={{fontSize:{lg:"18px",md:"16px",sm:"18px",xs:"16px"},fontFamily:"NovemberPro-Reg"}}  >At <b>InfoKoders</b>, we craft intuitive and visually appealing user interfaces that enhance user engagement and satisfaction. Our <b>UI/UX Development Services</b> focus on creating seamless, user-centric digital experiences that drive conversions and business growth. We combine <b>cutting-edge design principles, user psychology, and the latest industry trends</b> to deliver interfaces that are not only aesthetically pleasing but also functional and easy to navigate.
            </Typography>
            <Button sx={{fontSize:{lg:"16px",md:"14px",sm:"16px",xs:"14px"},fontFamily:"NovemberPro-Reg",cursor:"pointer",padding:"8px 18px",border:"1px solid transparent",color:"#ffffff",backgroundColor:"#333",marginTop:"1rem",marginBottom:"1rem",textTransform:"none"}} onClick={()=>setOpen(true)}>Get in touch</Button>
        ...
        <Grid container className={styles.servicesContainer}>
            <Grid>
              <Typography
                ...
                sx={{
                  fontSize:{lg:"25px",md:"22px",sm:"25px",xs:"22px"},fontFamily:"NovemberPro",paddingBottom:"20px"
                }}
              >
             Why UI/UX Matters?
              </Typography>
              <Typography className={styles.uiContent} sx={{fontSize:{lg:"18px",md:"16px",sm:"18px",xs:"16px"},fontFamily:"NovemberPro-Reg"}}>A well-designed UI/UX can <b>make or break </b> your digital presence. Users expect smooth, efficient, and engaging interactions when they visit a website or use an app. A poor user experience leads to frustration, increased bounce rates, and lost business opportunities.</Typography>
            </Grid>
          ...
          <Grid container className={styles.ProcessContainer}>
            <Grid size={{xs:12,sm:12,md:12,lg:12}} className={styles.ProcessGrid}>
              <Typography className={styles.obstaclesLeftTitle}  sx={{
                  fontSize:{lg:"25px",md:"22px",sm:"25px",xs:"22px"},fontFamily:"NovemberPro"
                }}>Our <span className={styles.OurUsp}> UI/UX </span>Development Process</Typography>
            </Grid>
            <Grid container spacing={3} className={styles.cardsContainer} >
            {Process?.map((item,index)=>(
            <Grid size={{xs:12,sm:12,md:6,lg:4}} className={styles.cardsProcessangular} key={index}>
              <Typography  className={styles.obstaclesLeftTitle}  sx={{
                  fontSize: {
                    lg: "20px ",
                    md: "20px ",
                    sm: "20px ",
                    xs: "20px",
                  },fontFamily: "NovemberPro",marginBottom:"1rem",textAlign:"center"}}> {item?.title}</Typography>
              <Typography className={styles.obstaclesLeftDesc} sx={{
                  fontSize: {
                    ...
                    sm: "16px ",
                    xs: "16px",
                  },fontFamily: "NovemberPro-Reg"}}>{item?.desc1}</Typography>
                   <Typography className={styles.obstaclesLeftDesc} sx={{
                  fontSize: {
                    lg: "16px ",
                    md: "16px ",
                    sm: "16px ",
                    xs: "16px",
                  },fontFamily: "NovemberPro-Reg"}}>{item?.desc2}</Typography>
                   <Typography className={styles.obstaclesLeftDesc} sx={{
                  fontSize: {
                    lg: "16px ",
                    md: "16px ",
                    sm: "16px ",
                    xs: "16px",
                  },fontFamily: "NovemberPro-Reg"}}>{item?.desc3}</Typography>
              </Grid>
            ))}
            </Grid>
          </Grid> 
          ...
          <Grid container className={styles.ProcessContainerDesign} >
            <Grid size={{xs:12,sm:12,md:12,lg:12}}>
              <Typography className={styles.DesignTitle} sx={{fontSize:{lg:"25px",md:"22px",sm:"25px",xs:"22px"},fontFamily:"NovemberPro"}} >What We Design</Typography>
              <Typography className={styles.DesignDesc} sx={{fontSize:{lg:"18px",md:"16px",sm:"18px",xs:"16px"},fontFamily:"NovemberPro-Reg"}}>We specialize in crafting seamless experiences for a variety of digital platforms:</Typography>
            </Grid>
            <Grid container spacing={3}>
              {Design?.map((item,index)=>(
              <Grid size={{xs:12,sm:12,md:6,lg:4}} key={index} className={styles.DesignBox}>
                <Image src={item?.image} alt='images of the what we design is not found' width={90} height={90} />
                <Typography sx={{fontSize:{lg:"20px",md:"20px",sm:"20px",xs:"20px"},fontFamily:"NovemberPro",marginTop:"10px"}} className={styles.uspBoxTitle}>{item?.title}</Typography>
                <Typography sx={{fontSize:{lg:"16px",md:"16px",sm:"16px",xs:"16px"},fontFamily:"NovemberPro-Reg"}} className={styles.uspBoxDesc}>{item?.desc}</Typography>
              </Grid>
              ))}
            </Grid>
          </Grid>
          ...
          <Grid container className={styles.infoCon}>
            <Grid size={{xs:12,sm:12,md:12,lg:12}}>
              <Typography className={styles.infoConTitle} sx={{fontSize:{lg:"25px",md:"22px",sm:"25px",xs:"22px"},fontFamily:"NovemberPro"}} >Why Choose InfoKoders Technologies?</Typography>
            </Grid>
            <Grid container spacing={3}>
              {infoCon?.map((item,index)=>(
              <Grid size={{xs:12,sm:12,md:6,lg:4}} key={index} className={styles.infoCards}>
                <Image src={item?.image} alt='images not found of the cards of the why choose infokoders' width={90} height={90}/>
                <Typography className={styles.uspBoxTitle} sx={{fontSize:{lg:"20px",md:"20px",sm:"20px",xs:"20px"},fontFamily:"NovemberPro",marginTop:"10px"}}>
                  {item?.title}
                </Typography>
                <Typography className={styles.uspBoxDesc} sx={{fontSize:{lg:"16px",md:"16px",sm:"16px",xs:"16px"},fontFamily:"NovemberPro-Reg"}}>{item?.desc}</Typography>
              </Grid>
              ))}
            </Grid>
          </Grid>
