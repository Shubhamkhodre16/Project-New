...
const AWSDevelopment = () => {
  ...
  const contactTitle="Are you ready to Renovate your business with AWS powered solution?"
  const contactSubtitle="Consult our AWS experts and embrace groundbreaking cloud computing services provided by Amazon."
  return (
    <Box>
      ...
      <Grid container className={styles.servicesContainer}>
        ...
        <Grid container className={styles.technologyContainer}>
          <Grid size={{xs:12,sm:12,md:12,lg:12}}>
            <Typography className={styles.techTitle} sx={{fontSize:{lg:"25px",md:"22px",sm:"25px",xs:"22px"},fontFamily:"NovemberPro",textAlign:"center"}}>Technologies</Typography>
          </Grid>
          <Grid container spacing={3}>
            {Technologies?.map((item,index)=>(
            <Grid size={{xs:12,sm:6,md:4,lg:2}} key={index} className={styles.technologiesBox} >
              <Image src={item?.image} alt="not image found" width={120} height={100}/>
              <Typography className={styles.techcardtitle} sx={{fontSize:{lg:"20px",md:"20px",sm:"20px",xs:"20px"},fontFamily:"NovemberPro"}}>{item?.title}</Typography>
            </Grid>
            ))}
          </Grid>
          </Grid>  
          ...
          <Grid size={{xs:12,sm:12,md:12,lg:12}} className={styles.gridExpert} >
            <Typography className={styles.coreTitleUsp}
                ...
                }}>  Reliable & Scalable AWS Cloud Computing platform</Typography>
            <Typography className={styles.coreDescriptionUsp}
                ...
                }}>AWS is formed by diverse cloud computing products and services. Amazon's extremely profitable division offers servers, storage, networking, remote computing, email, mobile development, and security. When a software development firm migrates its services to the cloud, Amazon's AWS services support in setting up the cloud environment with a combo of the platform as a service (PaaS), infrastructure as a service (IaaS), and packaged software as a service (SaaS) offerings.
                </Typography>
              <Typography className={styles.coreDescriptionUsp} sx={{fontSize:{lg:"18px",md:"16px",sm:"18px",xs:"16px"},fontFamily:"NovemberPro-Reg",marginTop:"20px"}}>The platform offers a landing zone, a tried-and-true business operating model, day-to-day infrastructure management, and ongoing cost reduction.</Typography>  
              <Typography className={styles.coreTitleUsp} sx={{
                  fontSize:{lg:"25px",md:"22px",sm:"25px",xs:"22px"},fontFamily:"NovemberPro",marginTop:"10px"}}>Advantages of AWS</Typography>
          </Grid>
        {/* node card */}
        <Grid
              container
        ...
        <Grid>
          <Grid className={styles.client}>
            <Grid className={styles.coreQuote}>
              ...
              >
               We know every client's desires for premium and exclusive development solutions and that’s where InfoKoders technologies praised for offering trustworthy AWS development solutions takes the spotlight. With whatever AWS requirements you come with, our specialized developers serve you with high tech and quality rich solutions that help you to stand alone from your competitors.
              </Typography>
            </Grid>
            <Grid container spacing={4} className={styles.coresubcont}>
                  ...
                  <Typography
                    ...
                    sx={{
                      fontSize: {
                        ...
                        sm: "20px ",
                        xs: "20px ",
                      },fontFamily: "NovemberPro",marginBottom:"10px"
                    }}
                  >
                    {item?.title}
                  </Typography>
