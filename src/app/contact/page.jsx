...
const page = () => {
  ...
  className="flex flex-col p-10 py-12 border border-gray-100 rounded-lg shadow-lg m-4 md:m-0 md:mr-4 md:w-1/2 font-circular">
    <span className="text-[#650909] text-[25px] font-bold mb-10 text-center">Contact Details</span>
    ...
    <span className="flex items-center text-center md:text-left mt-5 ">
      <LinkedInIcon className="mr-2"/> InfoKoders Technologies Private Limited
    </span>
...
<div>
  <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14720.558644985285!2d75.8820338!3d22.7230498!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xda822cee3e05d2ec!2sInfoKoders%20Technologies%20Private%20Limited!5e0!3m2!1sen!2sin!4v1652078046125!5m2!1sen!2sin" width="100%" height="450px"/>
  </div>
  <Footer/>
    </div>
